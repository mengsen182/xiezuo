...
<head>
    ...
    <script type="text/javascript">
        ...
        function querySelectType() {
            $.get("${pageContext.request.contextPath}/finance/queryAllType", function (finance) {
                $("#selectTypeCombobox").combobox({
                    valueField: 'typeid',
                    textField: 'typeName',
                    data: finance,
                    editable: false,
...
<div>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    操作时间:<input class="easyui-datebox" id="selectCreateDateNo1" name="careteDateNo1"
                data-options="required:true,showSeconds:false" value="3/4/2010 2:3" style="width:150px">
    至<input class="easyui-datebox" id="selectCreateDateNo2" name="careteDateNo2"
            data-options="required:true,showSeconds:false" value="3/4/2010 2:3" style="width:150px">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--添加windows-->
<div class="easyui-window" id="addFinanceWindow" closed="true" title="添加"
     style="top: 10%;left: 20%;width: 400px;height: 350px;padding: 40px 80px;">
...
<!--修改弹窗-->
<div class="easyui-window" id="updateFinanceWindow" closed="true" title="修改"
     style="top: 10%;left: 20%;width: 400px;height: 350px;padding: 40px 80px;">
